...
func Test30(t *testing.T) {
	...
	expectedPaths := []map[string]Path{
		...
		map[string]Path{
			"14": Path{"14", []Point{Point{2, 2, 0}, Point{2, 14, 0}}, "color3"},
		},
		map[string]Path{
			"22": Path{"22", []Point{Point{3, 3, 0}, Point{3, 18, 1}, Point{2, 18, 0}, Point{2, 22, 0}}, "color4"},
		},
		map[string]Path{
			"5":  Path{"5", []Point{Point{0, 4, 0}, Point{0, 5, 0}}, "color1"},
			"10": Path{"10", []Point{Point{0, 4, 0}, Point{4, 4, 2}, Point{4, 10, 0}}, "color5"},
		},
		map[string]Path{
			"6": Path{"6", []Point{Point{0, 5, 0}, Point{0, 6, 0}}, "color1"},
			"7": Path{"7", []Point{Point{0, 5, 0}, Point{5, 5, 2}, Point{5, 7, 0}}, "color6"},
		},
		map[string]Path{
			"16": Path{"16", []Point{Point{0, 6, 0}, Point{0, 16, 0}}, "color1"},
			"8":  Path{"8", []Point{Point{0, 6, 0}, Point{6, 6, 2}, Point{6, 8, 0}}, "color7"},
		},
		map[string]Path{
			"9": Path{"9", []Point{Point{5, 7, 0}, Point{5, 9, 0}}, "color6"},
		},
		map[string]Path{
			"11": Path{"11", []Point{Point{6, 8, 0}, Point{6, 11, 0}}, "color7"},
		},
		map[string]Path{
			"16": Path{"16", []Point{Point{5, 9, 0}, Point{5, 16, 1}, Point{0, 16, 0}}, "color6"},
		},
		map[string]Path{
			"18": Path{"18", []Point{Point{4, 10, 0}, Point{4, 18, 1}, Point{0, 18, 0}}, "color5"},
		},
		map[string]Path{
			"12": Path{"12", []Point{Point{6, 11, 0}, Point{6, 12, 0}}, "color7"},
		},
		map[string]Path{
			"13": Path{"13", []Point{Point{6, 12, 0}, Point{6, 13, 0}}, "color7"},
			"16": Path{"16", []Point{Point{6, 12, 0}, Point{0, 12, 3}, Point{0, 16, 0}}, "color1"},
		},
		map[string]Path{
			"21": Path{"21", []Point{Point{6, 13, 0}, Point{6, 16, 1}, Point{5, 16, 0}, Point{5, 18, 1}, Point{3, 18, 0}, Point{3, 21, 0}}, "color7"},
		},
		map[string]Path{
			"18": Path{"18", []Point{Point{2, 14, 0}, Point{2, 18, 1}, Point{0, 18, 0}}, "color3"},
		},
		map[string]Path{
			"23": Path{"23", []Point{Point{1, 15, 0}, Point{1, 23, 0}}, "color2"},
		},
		map[string]Path{
			"18": Path{"18", []Point{Point{0, 16, 0}, Point{0, 18, 0}}, "color1"},
			"17": Path{"17", []Point{Point{0, 16, 0}, Point{6, 16, 2}, Point{6, 17, 0}}, "color8"},
		},
		map[string]Path{
			"18": Path{"18", []Point{Point{6, 17, 0}, Point{6, 18, 1}, Point{0, 18, 0}}, "color8"},
		},
		map[string]Path{
			"20": Path{"20", []Point{Point{0, 18, 0}, Point{0, 20, 0}}, "color1"},
			"19": Path{"19", []Point{Point{0, 18, 0}, Point{4, 18, 2}, Point{4, 19, 0}}, "color6"},
		},
		map[string]Path{
			"20": Path{"20", []Point{Point{4, 19, 0}, Point{4, 20, 1}, Point{0, 20, 0}}, "color6"},
		},
		map[string]Path{
			"24": Path{"24", []Point{Point{0, 20, 0}, Point{0, 24, 0}}, "color1"},
		},
		map[string]Path{
			"22": Path{"22", []Point{Point{3, 21, 0}, Point{3, 22, 1}, Point{2, 22, 0}}, "color7"},
		},
		map[string]Path{
			"23": Path{"23", []Point{Point{2, 22, 0}, Point{2, 23, 1}, Point{1, 23, 0}}, "color4"},
		},
		map[string]Path{
			"24": Path{"24", []Point{Point{1, 23, 0}, Point{1, 24, 1}, Point{0, 24, 0}}, "color2"},
		},
	}
...
func Test31(t *testing.T) {
	// Initial input
	inputNodes := make([]map[string]interface{}, 0)
	inputNodes = append(inputNodes, map[string]interface{}{"id": "0", "parents": []string{"6"}})
	inputNodes = append(inputNodes, map[string]interface{}{"id": "1", "parents": []string{"5"}})
	inputNodes = append(inputNodes, map[string]interface{}{"id": "2", "parents": []string{"4"}})
	inputNodes = append(inputNodes, map[string]interface{}{"id": "3", "parents": []string{"8"}})
	inputNodes = append(inputNodes, map[string]interface{}{"id": "4", "parents": []string{"12"}})
	inputNodes = append(inputNodes, map[string]interface{}{"id": "5", "parents": []string{"7"}})
	inputNodes = append(inputNodes, map[string]interface{}{"id": "6", "parents": []string{"9"}})
	inputNodes = append(inputNodes, map[string]interface{}{"id": "7", "parents": []string{"10"}})
	inputNodes = append(inputNodes, map[string]interface{}{"id": "8", "parents": []string{"10", "11"}})
	inputNodes = append(inputNodes, map[string]interface{}{"id": "9", "parents": []string{"10"}})
	inputNodes = append(inputNodes, map[string]interface{}{"id": "10", "parents": []string{"13"}})
	inputNodes = append(inputNodes, map[string]interface{}{"id": "11", "parents": []string{"12"}})
	inputNodes = append(inputNodes, map[string]interface{}{"id": "12", "parents": []string{"13"}})
	inputNodes = append(inputNodes, map[string]interface{}{"id": "13", "parents": []string{}})

	out, _ := BuildTree(inputNodes, customColors)

	// Expected output
	expectedColumns := []int{0, 1, 2, 3, 2, 1, 0, 1, 3, 0, 0, 2, 1, 0}

	expectedPaths := []map[string]Path{
		map[string]Path{
			"6": Path{"6", []Point{Point{0, 0, 0}, Point{0, 6, 0}}, "color1"},
		},
		map[string]Path{
			"5": Path{"5", []Point{Point{1, 1, 0}, Point{1, 5, 0}}, "color2"},
		},
		...
		map[string]Path{
			"12": Path{"12", []Point{Point{2, 4, 0}, Point{2, 10, 1}, Point{1, 10, 2}, Point{1, 12, 0}}, "color3"},
		},
		map[string]Path{
			"7": Path{"7", []Point{Point{1, 5, 0}, Point{1, 7, 0}}, "color2"},
		},
		map[string]Path{
			"9": Path{"9", []Point{Point{0, 6, 0}, Point{0, 9, 0}}, "color1"},
		},
		map[string]Path{
			"10": Path{"10", []Point{Point{1, 7, 0}, Point{1, 10, 1}, Point{0, 10, 0}}, "color2"},
		},
		map[string]Path{
			"10": Path{"10", []Point{Point{3, 8, 0}, Point{1, 8, 3}, Point{1, 10, 1}, Point{0, 10, 0}}, "color2"},
			"11": Path{"11", []Point{Point{3, 8, 0}, Point{3, 10, 1}, Point{2, 10, 2}, Point{2, 11, 0}}, "color4"},
		},
		map[string]Path{
			"10": Path{"10", []Point{Point{0, 9, 0}, Point{0, 10, 0}}, "color1"},
		},
		map[string]Path{
			"13": Path{"13", []Point{Point{0, 10, 0}, Point{0, 13, 0}}, "color1"},
		},
		map[string]Path{
			"12": Path{"12", []Point{Point{2, 11, 0}, Point{2, 12, 1}, Point{1, 12, 0}}, "color4"},
		},
		map[string]Path{
			"13": Path{"13", []Point{Point{1, 12, 0}, Point{1, 13, 1}, Point{0, 13, 0}}, "color3"},
		},
	}
